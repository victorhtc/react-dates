...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _MonthSelector = __webpack_require__(13);
	  ...
	  _createClass(CalendarMonth, [{
	    ...
	    value: function () {
	      function render() {
	        ...
	        return _react2['default'].createElement('div', { className: calendarMonthClasses, 'data-visible': isVisible }, _react2['default'].createElement('table', null, enableDropdowns && _react2['default'].createElement('caption', { className: 'CalendarMonth__caption js-CalendarMonth__caption' }, _react2['default'].createElement(_MonthSelector2['default'], {
	          month: month,
	          onYearSelect: onYearSelect,
	          onMonthSelect: onMonthSelect,
	          phrases: phrases
	        })), !enableDropdowns && _react2['default'].createElement('caption', { className: 'CalendarMonth__caption js-CalendarMonth__caption' }, _react2['default'].createElement('strong', null, monthTitle)), _react2['default'].createElement('tbody', { className: 'js-CalendarMonth__grid' }, weeks.map(function (week, i) {
...
/***/ (function(module, exports) {
	...
	module.exports = require("./MonthSelector");
